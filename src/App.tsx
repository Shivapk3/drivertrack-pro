            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl pl-11 pr-4 py-3.5 text-white focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl px-4 py-3.5 text-white focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                  required
                />
              </div>
        ...
        <main className="max-w-7xl mx-auto p-4 sm:p-6">
          <div className="flex items-center gap-2 mb-6 border-b border-zinc-800">
            <button
              ...
              className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${adminTab === 'dashboard' ? 'border-violet-500 text-white' : 'border-transparent text-zinc-500 hover:text-zinc-300'}`}
            >
            ...
            <button
              ...
              className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${adminTab === 'drivers' ? 'border-violet-500 text-white' : 'border-transparent text-zinc-500 hover:text-zinc-300'}`}
            >
              ...
              <div className="lg:col-span-1">
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-5 sticky top-24">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="text-xs text-zinc-400 mb-1.5 block">Driver Phone Number *</label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label className="text-xs text-zinc-400 mb-1.5 block">Login Password *</label>
                      <input
                        type="text"
              ...
              <div className="lg:col-span-2">
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden">
                  <div className="px-5 py-4 border-b border-zinc-800">
                    <h3 className="font-semibold">Configured Fleet Operators</h3>
                  </div>
        ...
        <AnimatePresence mode="wait">
              ...
              {activeTrip ? (
                <>
                    ...
                    <div className="rounded-3xl bg-zinc-950 p-5">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="bg-zinc-900/50 rounded-2xl p-3 border border-zinc-800/50">
                          ...
                          <div className="text-[11px] text-zinc-500">Refuels</div>
                      ...
                      <div className="rounded-2xl bg-zinc-950 p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-xs font-medium text-orange-400 uppercase tracking-wider">Break Timer Active</div>
                  ...
                  <div className="space-y-3">
                    {!activeRest && (
                      <button onClick={() => setCurrentScreen('rest')} className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center">
                          <Pause className="w-6 h-6 text-orange-400" />
                        </div>
                        <div className="text-left">
                          <div className="font-medium">Take Rest Break</div>
                          <div className="text-xs text-zinc-500 mt-0.5">Suspend mileage log counters temporarily</div>
                        </div>
                      </button>
                    )}

                    <button onClick={() => setCurrentScreen('fuel')} className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center">
                        <Fuel className="w-6 h-6 text-amber-400" />
                      </div>
                      <div className="text-left">
                        <div className="font-medium">Add Fuel Entry</div>
                        <div className="text-xs text-zinc-500 mt-0.5">Log diesel dispatch parameters with receipt upload</div>
                      </div>
                    </button>

                    {!activeTrip.arrival_time ? (
                      <button onClick={() => setCurrentScreen('destination')} className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center">
                          <Flag className="w-6 h-6 text-cyan-400" />
                        </div>
                        <div className="text-left">
                          <div className="font-medium">Destination Reached</div>
                          <div className="text-xs text-zinc-500 mt-0.5">Log terminal arrival gauge numbers</div>
                        </div>
                      </button>
                    ) : (
                      <button onClick={() => setCurrentScreen('end')} className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-2xl p-[1px]">
                        <div className="rounded-2xl bg-zinc-950 p-4 flex items-center gap-4">
                          ...
                          <div className="text-left">
                            ...
                            <div className="text-xs text-zinc-500 mt-0.5">Terminate manifest and calculate efficiency metrics</div>
                          </div>
                        </div>
                      </button>
                    )}
                ...
                <div className="text-center py-12">
                  ...
                  <button onClick={() => setCurrentScreen('start')} className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-white text-black font-medium">
          ...
          {currentScreen === 'fuel' && (
            <motion.div key="fuel" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
              <div className="flex items-center gap-3 mb-2">
                <button onClick={() => setCurrentScreen('home')} className="p-2 hover:bg-zinc-900 rounded-xl"><ArrowLeft className="w-5 h-5" /></button>
                <h2 className="text-xl font-semibold">Log Station Refuel</h2>
              </div>
